...
<s:form namespace="/" action="courseTypeAction_findAll">
	...
	<table width="88%" border="0" class="emp_table" style="width:80%;">
	  ...
	  <tr>  
	    <td >总学时：</td>
	    <td >
	    	<s:textfield name="totalStart" size="12"></s:textfield> 至  <s:textfield name="totalEnd" size="12"></s:textfield>
	    </td>
	  </tr>
	  <tr>
	    <td>课程费用：</td>
	    <td >
	    	<s:textfield name="courseCostStart" size="12"></s:textfield> 至 <s:textfield name="courseCostEnd" size="12"></s:textfield>
	  </tr>
	</table>
</s:form>
